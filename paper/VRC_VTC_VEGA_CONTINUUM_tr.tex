...
\title{VRC VTC VEGA CONTINUUM: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VRC VTC VEGA CONTINUUM'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
