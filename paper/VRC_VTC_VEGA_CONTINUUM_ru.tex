...
\title{VRC VTC VEGA CONTINUUM: Концептуальная основа}
...
\begin{abstract}
Данная работа представляет VRC VTC VEGA CONTINUUM как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
